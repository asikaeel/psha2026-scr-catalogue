...
The dataset extends the global SCR earthquake catalogue originally published by EPRI (2012) by integrating events from the Reviewed ISC Bulletin for the selected Fennoscandian analogue domains, performing magnitude harmonisation, and removing both duplicate and anthropogenic events. All processing steps are documented in detail in the thesis. All processing steps are documented in detail in the thesis.
